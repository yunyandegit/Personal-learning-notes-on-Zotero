...
![Alt text](pictures\4-1-1%E8%A1%A5.png)
![Alt text](pictures\4-1-2%E8%A1%A5.png)
![Alt text](pictures\4-1-3%E8%A1%A5.png)

## 4.1 文献管理软件的优势（Zotero更加强大）
### （1）使用文件夹的问题
![Alt text](pictures\4-1-4%E8%A1%A5.png)
### （2）使用excel的优缺点
![Alt text](pictures\4-1-5%E8%A1%A5.png)
### （3）所以使用文献管理软件
![Alt text](pictures\4-1-6%E8%A1%A5.png)
### （4）几种常用文献管理软件对比——选择Zotero
![Alt text](pictures\4-1-7%E8%A1%A5.png)
![Alt text](pictures\4-1-8%E8%A1%A5.png)
...
![Alt text](pictures\4-1.gif)

## 4.3 安装软件Zotero
&emsp;&emsp;首先双击安装包，然后点击Next。之后如下一堆图安装即可。（该过程b站教程没有，只有本人制作截图补充了。）
![Alt text](pictures\4-2.png)
![Alt text](pictures\4-3.png)
![Alt text](pictures\4-4.png)
![Alt text](pictures\4-5.png)
![Alt text](pictures\4-6.png)
![Alt text](pictures\4-7.png)
...
![Alt text](pictures\4-8.gif)
&emsp;&emsp;之后，如下图，点击Zotero插件的眼睛，让插件在上方栏里进行显示。
![Alt text](pictures\4-9.png)
&emsp;&emsp;下图是谷歌上Zotero的插件的安装方法。
![Alt text](pictures\4-10.png)
![Alt text](pictures\4-11.png)

___  
# 五、收集题录
![Alt text](pictures\5-1-1%E8%A1%A5.png)
...
![Alt text](pictures\5-1-2%E8%A1%A5.png)
...
![Alt text](pictures\5-1-3%E8%A1%A5.png)
&emsp;&emsp;下图是外文数据库。
![Alt text](pictures\5-1-4%E8%A1%A5.png)
&emsp;&emsp;下图是是普通的页面网页，还有些博客之类的，我们都可以将它们的题录信息进行收集。
![Alt text](pictures\5-1-5%E8%A1%A5.png)
&emsp;&emsp;收集进来以后，如下图所示，这个就是Zotero的一个主界面。它的所有的内容都在它的主界面上，在主界面的中间这一块内容就是我们刚才搜集的这些信息。
![Alt text](pictures\5-1-6%E8%A1%A5.png)
...
![Alt text](pictures\5-2.gif)
&emsp;&emsp;然后如下图所示安装茉莉花插件。（发现不兼容）
![Alt text](pictures\5-3.png)
![Alt text](pictures\5-4.png)
![Alt text](pictures\5-5.png)
![Alt text](pictures\5-6.png)
...
<div align="center">
  <img src="pictures\5-18-%E4%B8%AD%E9%97%B4%E8%A1%A51.gif" alt="Alt text" />
  <p><em>直接进入检索可正常使用Zotero插件的示意图</em></p>
</div>
<div align="center">
  <img src="pictures\5-18-%E4%B8%AD%E9%97%B4%E8%A1%A52.gif" alt="Alt text" />
...
![Alt text](pictures\6-12.png)
&emsp;&emsp;如下图所示，添加完成的笔记，它会在“注释”这一块存储注释笔记。<br>
![Alt text](pictures\6-13.png)
...
![Alt text](pictures\6-16.png)
![Alt text](pictures\6-17.png)
&emsp;&emsp;然后如下图所示，输入URL地址，设定更新的时间间隔。<br>
![Alt text](pictures\6-18.png)
...
![Alt text](pictures\6-19.png)
&emsp;&emsp;下图就是它自动抓取的这个效果。<br>
![Alt text](pictures\6-20.png)

## 6.7 快捷键
![Alt text](pictures\6-21.png)
...
![Alt text](pictures\7-17.png)

## 7.6 移除引文目录的域代码
![Alt text](pictures\7-18.png)
...
![Alt text](pictures\8-5.png)
![Alt text](pictures\8-6.png)
![Alt text](pictures\8-7.png)
&emsp;&emsp;之后，复制密码。<br>
![Alt text](pictures\8-8.png)
...
![Alt text](pictures\9-14.png)
![Alt text](pictures\9-15.png)
